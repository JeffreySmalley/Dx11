...
void Terrain::LoadHeightmap()
{
	...
	//RL If the file contains data read the RAW bytes
	//RL When complete close the file

	//RL Copy the array data into a float array and scale it.
}

void Terrain::Smooth()
{
	//RL This is the smoothing algorithm. Take particular note of how the Average function works
