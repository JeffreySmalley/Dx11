...
void ParticleSystem::BuildVB(ID3D11Device* device)
{
	...
	//RL Reuse the Buffer Description vbd and change it's ByteWidth and BindFlags so it can be used for SO
	//RL Also create two buffers to use the ping-pong technique detailed in the slides.
}